...
class User: ObservableObject, Identifiable, Hashable, Codable, Equatable {
    ...
    init(name: String = "", grade: String = "9", subject: String = "", email: String = "", password: String = "", isTutor: Bool = false) {
        self.name = name
        self.grade = grade
